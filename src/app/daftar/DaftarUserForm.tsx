...
export default function DaftarUserForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    login({ nama: form.nama, email: form.email, telepon: form.telepon, joinedAt: new Date().toISOString() });
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-120 mx-auto space-y-lg">
      ...
      {error && (
        <div className="flex items-center gap-sm bg-error-container text-on-error-container px-lg py-md rounded-xl text-body-md font-body-md">
